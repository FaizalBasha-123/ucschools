...
export const enum ElementTypes {
  ...
  VIDEO = 'video',
  AUDIO = 'audio',
  /** Inline SVG diagram generated by the LLM — zero-cost alternative to AI images */
  SVG = 'svg',
}
...
/**
 * SVG element (inline diagram)
 *
 * type: element type (svg)
 *
 * svg: complete sanitized `<svg ...>...</svg>` markup
 *
 * alt: accessibility description (alt text)
 */
export interface PPTSvgElement extends PPTBaseElement {
  type: 'svg';
  /** Complete sanitized SVG markup. Should start with `<svg` and end with `</svg>`. */
  svg: string;
