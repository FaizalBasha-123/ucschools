  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          'bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border-l border-primary/10 dark:border-primary/20 shadow-[-2px_0_24px_rgba(0,0,0,0.02)] flex flex-col shrink-0 z-20 relative overflow-visible',
          className,
        )}
      >
        {/* Drag handle */}
