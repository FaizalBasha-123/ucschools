  ...
  if (notes.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-6">
        <div className="w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-2xl flex items-center justify-center mb-3 text-primary ring-1 ring-primary/20 dark:ring-primary/30">
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              {isCurrent && (
                <span className="text-[9px] font-bold px-1.5 py-px rounded-full bg-primary/10 dark:bg-primary/20 text-primary">
