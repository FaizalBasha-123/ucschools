  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden bg-card dark:bg-slate-900/50">
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-primary/10 dark:bg-primary/20 rounded-2xl flex items-center justify-center shadow-lg shadow-primary/10 dark:shadow-primary/20 ring-1 ring-primary/20 dark:ring-primary/30"
      >
      ...
      >
        <div className="flex items-center gap-2 text-muted-foreground">
          <div className="w-7 h-7 rounded-lg bg-primary/5 dark:bg-primary/10 flex items-center justify-center">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-primary text-primary-foreground rounded-full font-medium shadow-lg shadow-primary/20 dark:shadow-primary/40 hover:shadow-primary/30 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isReview &&
                  !selected &&
                  'border-gray-200 dark:border-gray-600 hover:border-primary/30 dark:hover:border-primary/50 hover:bg-primary/5 dark:hover:bg-primary/10',
                !isReview &&
                  selected &&
                  'border-primary/50 bg-primary/10 dark:bg-primary/20 ring-1 ring-primary/20 dark:ring-primary/40',
                // Review states
                isReview &&
                  isCorrectOpt &&
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview && selected && 'bg-primary text-primary-foreground',
              ...
              <span
                className={cn(
                  ...
                  !isReview &&
                    !isSelected &&
                    'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400',
                  !isReview && isSelected && 'bg-primary text-primary-foreground',
                  isReview && isCorrectOpt && 'bg-emerald-500 text-white',
      ...
      {!isReview ? (
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 pb-10 rounded-xl border border-gray-200 dark:border-gray-600 text-sm resize-none focus:outline-none focus:border-primary/40 dark:focus:border-primary/60 focus:ring-2 focus:ring-primary/10 dark:focus:ring-primary/20 transition-all disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:text-gray-500 dark:bg-gray-800/50 dark:text-gray-200 dark:placeholder:text-gray-500"
          />
          <SpeechButton
            size="sm"
            disabled={disabled}
        ...
        <div className="space-y-3">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-emerald-50/50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800/30">
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              ...
              <button
                ...
                className={cn(
                  ...
                  allAnswered
                    ? 'bg-gradient-to-r from-primary to-emerald-600 text-primary-foreground shadow-sm hover:shadow-md hover:shadow-primary/20 dark:hover:shadow-primary/40 active:scale-[0.97]'
