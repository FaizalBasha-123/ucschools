      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-primary/90 dark:bg-primary/80 text-white shadow-[0_0_12px_rgba(22,163,74,0.45)] dark:shadow-[0_0_12px_rgba(22,163,74,0.3)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-primary/40 dark:border-primary/25"
