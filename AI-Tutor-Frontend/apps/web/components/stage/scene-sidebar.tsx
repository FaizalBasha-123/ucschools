                ...
                <div className="relative aspect-video w-full rounded overflow-hidden bg-muted dark:bg-neutral-800 ring-1 ring-black/5 dark:ring-white/5">
                  <div className="absolute inset-0 flex items-center justify-center">
                    {isSlide && slideContent ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-blue-50 to-teal-50 dark:from-blue-950/30 dark:to-teal-950/20 p-1.5 flex flex-col">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isActive &&
                      !isFailed &&
                      'bg-primary/10 dark:bg-primary/20 ring-1 ring-primary/20 dark:ring-primary/40 opacity-100',
                  )}
                >
                  {/* Scene Header */}
                  <div className="flex justify-between items-center px-2 pt-0.5">
