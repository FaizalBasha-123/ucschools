    ...
    <section className="w-full max-w-6xl mx-auto py-24 md:py-32 px-4 md:px-8 border-t border-border/40">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <motion.div
          ...
          className="group rounded-3xl border border-slate-200/60 dark:border-border/60 bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl shadow-sm hover:shadow-lg transition-all p-8 flex flex-col"
        >
          ...
          <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">The Student</h3>
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium mb-6">
            "11 PM cramming made safe."
          </p>
          <p className="text-sm text-slate-500 dark:text-slate-500 leading-relaxed mt-auto">
        ...
        <motion.div
          ...
          className="group rounded-3xl border-2 border-primary/20 bg-white dark:bg-slate-900/80 backdrop-blur-xl shadow-md hover:shadow-xl transition-all p-8 flex flex-col relative sm:-translate-y-4"
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 h-1 w-20 bg-primary rounded-b-full shadow-[0_0_10px_rgba(30,215,96,0.5)]" />
          ...
          <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">The Educator</h3>
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium mb-6">
        ...
        >
          ...
          <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">The Polymath</h3>
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium mb-6">
