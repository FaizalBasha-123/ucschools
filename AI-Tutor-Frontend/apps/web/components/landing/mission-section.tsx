    ...
    <section className="w-full max-w-6xl mx-auto py-24 md:py-32 px-4 md:px-8 border-t border-border/40 mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative">
          {/* Decorative glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-emerald-500/10 dark:bg-emerald-500/20 blur-3xl rounded-full pointer-events-none" />
          ...
          <motion.div
            ...
            className="p-6 rounded-3xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm border border-slate-200/50 dark:border-border/50 shadow-sm relative z-10"
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">Semantic Memory</h3>
          ...
          <motion.div
            ...
            className="p-6 rounded-3xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm border border-slate-200/50 dark:border-border/50 shadow-sm relative z-10 sm:translate-y-8"
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">Infinite Patience</h3>
            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
