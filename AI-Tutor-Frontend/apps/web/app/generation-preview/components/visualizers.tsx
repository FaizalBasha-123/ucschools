    ...
    <div className="w-60 h-40 mx-auto flex items-center justify-center">
      <div className="flex gap-3">
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className="w-14 h-20 rounded-lg bg-gradient-to-br from-primary to-emerald-500 dark:from-primary dark:to-emerald-700 shadow-lg"
  ...
  const actionItems = [
    {
      ...
      activeBorder: 'border-primary/20 dark:border-primary/40',
    },
    {
      icon: Focus,
      label: 'Spotlight',
    ...
    <div className="size-56 relative flex items-center justify-center">
      ...
      <div className="w-44 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden relative">
        ...
        <div className="p-2 space-y-1.5 relative">
          ...
          <motion.div
            className="absolute left-2 right-2 rounded-lg bg-primary/6 dark:bg-primary/10"
            style={{ height: ROW_H - 6 }}
