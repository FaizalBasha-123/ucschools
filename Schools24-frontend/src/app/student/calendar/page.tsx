    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-6 xl:grid-cols-3">
                <div className={`xl:col-span-2 ${mobileView === 'events' ? 'hidden sm:block' : ''}`}>
                ...
                <Card className={`lg:col-span-1 flex flex-col h-auto lg:h-[600px] border-0 shadow-lg ${mobileView === 'calendar' ? 'hidden sm:flex' : 'flex'}`}>
