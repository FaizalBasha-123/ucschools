...
pub enum SlideElement {
    ...
    /// Inline SVG diagram generated by the LLM (sanitized server-side).
    /// Used for anatomical diagrams, circuit schematics, labeled structures, etc.
    Svg {
        id: String,
        left: f32,
        top: f32,
        width: f32,
        height: f32,
        /// Complete `<svg ...>...</svg>` markup, already stripped of scripts.
        svg: String,
...
pub enum VisualType {
    ...
    #[default]
    None,
    /// Inline SVG diagram (anatomy, circuit, labeled structure, flow diagram).
    Svg,
