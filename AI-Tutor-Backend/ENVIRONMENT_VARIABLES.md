...
| `AI_TUTOR_ACCESS_TOKEN_TTL_SECONDS` | No | `86400` | `86400` | User session (access token) TTL (default 24 hours) |
| `AI_TUTOR_REFRESH_TOKEN_TTL_DAYS` | No | `90` | `90` | User refresh token TTL (default 90 days) |
